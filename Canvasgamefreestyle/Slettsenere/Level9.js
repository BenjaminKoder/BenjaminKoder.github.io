...
function animate() {
    ...
    //Win condition
    if (scrollOffset > 3350 && scrollOffset<3360) {
        console.log("You won")
        end = window.performance.now();
        celebration.play();
        alert("Du vant! Gratulerer! Du brukte "+antalldød+" forsøk og "+time.toFixed(1)+ " sekunder på det siste forsøket.");
        antalldød=1;
        ...
        nestelevelEl.innerHTML = "<a id='nestelevel' href='./Level10.html'>Neste Level</a>";
        init();
    }
