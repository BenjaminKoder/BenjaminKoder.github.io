...
player = new Player()
//lager en ny platform med "Platform"-objektet
platforms = [new Platform({x:-600,y:innerHeight-40,width:100, height:40}),
    ...
    new Platform({x:5200,y:innerHeight-200,width:1000, height:200}),
]
//kaller på update-metoden:
...
function animate() {
    ...
    //Win condition
    if (scrollOffset < -1880 && scrollOffset>-1890) {
        console.log("You won")
        ...
        nestelevelEl.innerHTML = "<a id='nestelevel' href='./Level11.html'>Neste Level</a>";
        init();
    }
