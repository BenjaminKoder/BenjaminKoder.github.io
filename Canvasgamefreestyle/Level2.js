...
player = new Player()
//lager en ny platform med "Platform"-objektet
platforms = [new Platform({x:-300,y:innerHeight-200,width:700, height:50}), 
    ...
    new Platform({x:2770,y:innerHeight-100,width:400, height:50}), 
    new Platform({x:3240,y:innerHeight-150,width:400, height:50}), 
    new Platform({x:3710,y:innerHeight-200,width:400, height:50}), 
    new Platform({x:4180,y:innerHeight-250,width:200, height:50}), 
    new Platform({x:4530,y:innerHeight-50,width:600, height:50}),
]
//kaller på update-metoden:
...
function animate() {
    ...
    //Win condition
    if (scrollOffset > 4600 && scrollOffset<4610) {
        console.log("You won")
        ...
        nestelevelEl.innerHTML = "<a id='nestelevel' href='./Level3.html'>Neste Level</a>";
        init();
    }
