...
platforms = [new Platform({x:-300,y:innerHeight-50,width:700, height:50}), 
    ...
    new Platform({x:2200,y:innerHeight-50,width:300, height:50}), 
    new Platform({x:2600,y:innerHeight-70,width:300, height:70}), 
    new Platform({x:3100,y:innerHeight-40,width:300, height:40}), 
]
//kaller på update-metoden:
...
function animate() {
    ...
    //Win condition
    if (scrollOffset > 2930 && scrollOffset<2940) {
        console.log("You won")
        ...
        nestelevelEl.innerHTML = "<a id='nestelevel' href='./Level4.html'>Neste Level</a>";
        init();
    }
